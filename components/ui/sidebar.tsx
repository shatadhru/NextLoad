  ...
  return (
    ...
    >
      ...
      <div
        ...
        data-side={side}
        className={cn(
          "fixed inset-y-0 left-0 z-10 hidden h-svh transition-[width] duration-200 ease-linear md:flex flex-col border-r border-sidebar-border bg-sidebar",
          isCollapsed ? "w-14 p-1.5" : "w-64 p-2",
          className
        )}
        {...props}
      >
